...
import { editBrand, brandSelector } from "@/store/slices/brandSlice";
...
export default function EditBrandModal({
  ...
  const { isLoading } = useSelector(brandSelector);
  ...
  const submit = (e) => {
    e.preventDefault();
    dispatch(editBrand(brand_id, brandName, brandExplanation, brandPhoto));
  };
